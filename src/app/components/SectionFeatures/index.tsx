...
export function SectionFeatures(){
  return(
    <section>
      <GridContainer className="py-24">
        <div className="text-center mb-16">
          <small className="block text-brand-700 text-base font-semibold mb-3">Features</small>
          <h2 className="text-center text-4xl text-gray-900 tracking-tighter-[-0.72px] font-semibold mb-5">Analytics that feels like it’s from the future</h2>
